...
const Page = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("https://admin.kadiprestige.com/api/detail_sections/28")
    ...
    const fetchBannerDetails = async () => {
      try {
        const response = await fetch("https://admin.kadiprestige.com/api/detail_sections/37");
        const data = await response.json();

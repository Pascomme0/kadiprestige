      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 bg-blue-700 flex items-center justify-center p-4 sm:p-8">
          <div className="text-white">
            ...
            <p className="text-sm sm:text-base">lorem ipsum dolor sit alet consortium  lorem ipsum dolor sit alet consortium  lorem ipsum dolor sit alet consortium
            lorem ipsum dolor sit alet consortium lorem ipsum dolor sit alet consortium  lorem ipsum dolor sit alet consortium lorem ipsum dolor sit alet consortium
            </p>
          </div>
        </div>
